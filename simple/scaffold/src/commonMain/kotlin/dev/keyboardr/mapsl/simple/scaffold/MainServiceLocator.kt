...
import dev.keyboardr.mapsl.simple.scaffold.MainServiceLocator.register
      ...
      check(!::instance.isInitialized) {
        if (instance is PreRegistered) {
          """MainServiceLocator was registered automatically. If you wish to register manually,
            | disable dev.keyboardr.mapsl.simple.scaffold.ServiceLocatorInitializer.
...
): T = getOrProvide({ it == ServiceLocatorScope.Production }, threadSafetyMode, provider)
